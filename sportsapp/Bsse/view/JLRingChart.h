...
//十个自带颜色
#define RING_COLOR_ARR(R) @[kColor(255, 0, 0, R),kColor(0, 255, 0, R),kColor(0, 0, 255, R),kColor(255, 97, 0, R),kColor(160, 32, 240, R),kColor(0, 121, 176, R),kColor(49, 58, 134, R),kColor(139, 42, 125, R),kColor(228, 55, 117, R),kColor(45, 103, 51, R)]

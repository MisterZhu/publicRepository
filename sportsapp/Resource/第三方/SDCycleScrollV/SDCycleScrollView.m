...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        ...
        case SDCycleScrollViewPageContolStyleClassic:
        {
            ...
            //            [pageControl setValue:[UIImage imageNamed:@"pageCurrent"] forKey:@"_currentPageImage"];
            //            [pageControl setValue:[UIImage imageNamed:@"pageOther"] forKey:@"_pageImage"];
            [pageControl setValue:[UIImage imageNamed:@"pageDotColor"] forKeyPath:@"pageImage"];
            [pageControl setValue:[UIImage imageNamed:@"currentPageDotColor"] forKeyPath:@"currentPageImage"];
            pageControl.userInteractionEnabled = NO;
            pageControl.currentPage = indexOnPageControl;
            [self addSubview:pageControl];
            _pageControl = pageControl;

...
-(void)setUpPickView{
    ...
    [pickView selectRow:self.selectIndex inComponent:0 animated:YES];
...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    datePicker.frame=CGRectMake(0, ZHToobarHeight, KScreenWidth, datePicker.frame.size.height);
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view{
    ...
    if (!pickerLabel){
        ...
        pickerLabel.font = FrameSecondFont;
    }
...
-(void)remove{
    ...
    if ([self.delegate respondsToSelector:@selector(toobarDonBtnHaveClick:resultString:)]) {
        ...
        [self.delegate toobarDonBtnHaveClick:self resultString:nil];
    }
